...
1. Deploy all components under templates/ in kubernetes using helm 
 `helm upgrade --install heart-disease-api ./k8s` 
...
4. Logs for a pod (replace with actual pod name)
